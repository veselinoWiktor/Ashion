...
namespace Ashion.Infrastructure.Data.Migrations
{
    ...
    [Migration("20231002092959_AddUsersCartsEntity")]
    partial class AddUsersCartsEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ashion.Infrastructure.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "71500453-855b-44f4-81cf-a46b41e3a16e",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGy5tfrUn4wB9XCRBt3u2O2cyfczVNohw//TqmKjiKlReCPvYPetuD0XXB9OBvXcoA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "969f0115-de78-4426-a467-49b0dba3129e",
                            TwoFactorEnabled = false,
                            UserName = "admin@mail.com"
                        });
                });

            modelBuilder.Entity("Ashion.Infrastructure.Data.Entities.UserCart", b =>
                {
                    ...
                    b.HasKey("UserId", "ProductId", "ProductType");
            ...
            modelBuilder.Entity("Ashion.Infrastructure.Data.Entities.UserCart", b =>
                {
                    b.HasOne("Ashion.Infrastructure.Data.Entities.User", "User")
                        .WithMany()
